				...
				<contenido>
					...
					<tabla_solicitud>
						<encabezado>
				       	...
				       	<xsl:choose>
				         	<xsl:when test="$archivos/ArchivoAdjunto[./descripcion='Poder al abogado para realizar la solicitud (Si aplica)']">
				           		<fila>
									<valor>
										Poder al abogado para realizar la solicitud
									</valor>
									<valor>
										<xsl:value-of select="$archivos/ArchivoAdjunto[./descripcion='Poder al abogado para realizar la solicitud (Si aplica)']/nombre_archivo" />.<xsl:value-of select="$archivos/ArchivoAdjunto[./descripcion='Poder al abogado para realizar la solicitud (Si aplica)']/extension_archivo" />
									</valor>
								</fila>
				         	</xsl:when>
				         	<xsl:otherwise>
						...
						<xsl:for-each select="$archivos/ArchivoAdjunto[./descripcion='Plan de negocios']">
							<fila>
								<valor>
									<xsl:value-of select="descripcion"/>
								</valor>

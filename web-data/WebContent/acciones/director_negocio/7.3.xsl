...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="OSM-ACCION">
		...
		<pagina titulo="Guardar Director de Negocio">
			
			<principal>
				<titulo>Guardar Director de Negocio</titulo>
				<contenido>
				<div class="box-container">
					...
					<bloque-contenido>
						...
						<contenido>
							<parrafo>
								<xsl:variable name="Valor" select="//guardarDirectorNegocio/exito" />
								<xsl:choose>
									...
									<xsl:when test="$Valor = '4'">
										No es crear la relación de la persona con el negocio!
									</xsl:when>

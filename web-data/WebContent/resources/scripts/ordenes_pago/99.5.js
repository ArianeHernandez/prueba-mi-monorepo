...
function contarArchivos(){
	...
	jsonrpc._("ordenesPagoServicio.contarBuscarArchivos")(buscarArchivos, id_usuario, id_ftp_usuario_archivo, id_formato, id_carga, fecha_inicial, fecha_final, nombre, estado, null);
}
...
function buscarArchivos(total){
	if (total != null){
		...
		jsonrpc._("ordenesPagoServicio.buscarArchivos")(mostrarArchivos, id_usuario, id_ftp_usuario_archivo, id_formato, id_carga, fecha_inicial, fecha_final, nombre, estado, null, PAGINA_ACTUAL, TAMANO_PAGINA);
	}else {
	...
	if (respuesta != null){
		...
		for ( var i = 0; i < archivos.length; i++) {
			...
			osm_construirHTML("archivos_obtenidos", "PLANTILLA_ARCHIVOS", [reg.id_ftp_usuario_archivo, id_lote, reg.nombre, reg.fecha_cargue_formato,
			                                                               ...
			                                                               reg.estado_formato, reg.caracteristica, duplicado]);
			if (reg.duplicado == 'S'){
...
function descargarReporte() {
	...
	jsonrpc._("ordenesPagoServicio.generarArchivoExcel")(mostrarVentanaReporte, id_usuario, id_ftp_usuario_archivo, id_formato, id_carga, fecha_inicial, fecha_final, nombre, estado, null);

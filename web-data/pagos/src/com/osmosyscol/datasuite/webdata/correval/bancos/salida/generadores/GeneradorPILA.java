...
public class GeneradorPILA implements Generador {
	...
	public String getCodBanco() {
		return GeneradorUtils.getCodBancoByDesc("PILA");
	}
	...
	public File generar(SalidaBanco salidabanco, IPorcentaje porcentaje) {
		...
		for (RegistroEntradaBanco registro : registros) {
			...
			String codigo = StringUtils.trimToEmpty(DS_SqlUtils.queryForObject(String.class, "select $retiros.referencia 1$ from $retiros$ r where idcarga = " + carga.getId_carga()));

...
public class InterpreteRespuestaBancolombiaSAP implements IInterpreteRespuestaBanco {
	...
	public List<RespuestaBanco> obtenerRespuestasPorBanco(String rutaArchivo, String id_banco) {
		...
		try {
			...
			Integer[] longitudes = new Integer[] { 13, 8, 1, 1, 15, 18, 9, 17, 1, 2, 18, 9, 13, 3, 8, 8 };

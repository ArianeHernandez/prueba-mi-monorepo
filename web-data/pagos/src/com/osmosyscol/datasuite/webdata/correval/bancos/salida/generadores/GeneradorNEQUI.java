...
public class GeneradorNEQUI implements Generador {
	...
	public String getCodBanco() {
		return GeneradorUtils.getCodBancoByDesc("NEQUI");
	}
	...
	public File generar(SalidaBanco salidabanco, IPorcentaje porcentaje) {
		...
		for (RegistroEntradaBanco registro : registros) {
			...
			String cuenta = registro.getNum_cuenta_beneficiario();

			r.append(carga.getId_carga() + ";" + tipo_documento + ";" + numero_documento + ";" + cuenta + ";" + valor.toPlainString() + ";" + fecha_giro);

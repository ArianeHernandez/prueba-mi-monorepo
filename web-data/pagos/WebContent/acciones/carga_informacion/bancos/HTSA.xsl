...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="OSM-ACCION">
		...
		<javascript>htsa/htsFormato.js</javascript>
						...
						<div class="panel-body">
							...
							<div class=" form-horizontal">
								...
								<parrafo>
									...
									<input type="hidden"  name="url" value="/carga_informacion/bancos/HTSA_0.do"/>
...
<!-- 								<boton estilo="volver" id="btn_descargar_excel" accion="descargar_excel();osm_go('/xls.download?id_formato={//ID_FORMATO}&amp;id_persona={//Persona/id_persona}', false)"><i class="fa fa-download" aria-hidden="true"/> Descargar Formato</boton> -->
								
								<form action="../../DescargaArchivoServlet" id="form_download_format" style="display:inline" method="post">
									<input type="hidden" id="id_archivo" name="id_archivo" value=""/>
									<boton estilo="volver" accion="descargar_formato()"><i class="fa fa-download" aria-hidden="true"></i><span class="hide-xs">&#160; Descargar Formato</span></boton>
					  			</form>
								
								<boton estilo="aceptar" formulario="form_sendfile" validacion="validarArc()"><i class="fa fa-check" aria-hidden="true"></i>	Cargar</boton>

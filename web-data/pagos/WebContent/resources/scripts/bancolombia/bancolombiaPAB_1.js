...
function pintardetalle(respuesta, e){
	...
	if(respuesta!=null)
	{
		...
		for (var i = 0; i < listado.length ; i++){
			...
			if(retiro.tipo_cuenta_beneficiario_banco == "S"){
				tipocuenta = "Ahorros";
			}
			
			if(retiro.tipo_cuenta_beneficiario_banco == "D"){
			...
			[ retiro.nombre_beneficiario, retiro.identificacion_beneficiario, nombre_banco, retiro.cuenta_beneficiario, tipocuenta, retiro.valor, retiro.observacion ]);
		}
	}

...
function pintardetalle(respuesta, e){
	...
	if(respuesta!=null)
	{
		...
		for (var i = 0; i < listado.length ; i++){
			...
			if(retiro.tipo_cuenta_beneficiario_banco.toUpperCase() == "Cuenta de Ahorros".toUpperCase()){
				tipocuenta = "Ahorros";
			}
			
			else if(retiro.tipo_cuenta_beneficiario_banco.toUpperCase() == "Cuenta corriente".toUpperCase()){
				tipocuenta = "Corriente";
			}
			else if(retiro.tipo_cuenta_beneficiario_banco.toUpperCase() == "Credito Rotativo".toUpperCase()){
				tipocuenta = "Credito rotativo";
			}

...
public class RespuestaDTO  implements java.io.Serializable {
    ...
    /**
     * Gets the nombre value for this RespuestaDTO.
     * 
     * @return nombre
     */
    ...
    /**
     * Sets the nombre value for this RespuestaDTO.
     * 
     * @param nombre
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", ">RespuestaDTO"));

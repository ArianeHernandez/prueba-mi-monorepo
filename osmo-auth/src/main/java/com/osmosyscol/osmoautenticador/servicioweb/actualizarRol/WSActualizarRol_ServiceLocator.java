...
public class WSActualizarRol_ServiceLocator extends org.apache.axis.client.Service implements com.osmosyscol.osmoautenticador.servicioweb.actualizarRol.WSActualizarRol_Service {
    ...
    private java.lang.String WSActualizarRolSOAP_address = "http://localhost:9090/OsmoAutenticador/services/WSActualizarRolSOAP";
    ...
    public com.osmosyscol.osmoautenticador.servicioweb.actualizarRol.WSActualizarRol_PortType getWSActualizarRolSOAP(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.osmosyscol.osmoautenticador.servicioweb.actualizarRol.WSActualizarRolSOAPStub _stub = new com.osmosyscol.osmoautenticador.servicioweb.actualizarRol.WSActualizarRolSOAPStub(portAddress, this);
            _stub.setPortName(getWSActualizarRolSOAPWSDDServiceName());
            return _stub;
        }
        catch (org.apache.axis.AxisFault e) {
        	SimpleLogger.setError("Error obteniendo WSActualizarRolSOAPStub", e);
            return null;
        }
    }
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.osmosyscol.osmoautenticador.servicioweb.actualizarRol.WSActualizarRol_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.osmosyscol.osmoautenticador.servicioweb.actualizarRol.WSActualizarRolSOAPStub _stub = new com.osmosyscol.osmoautenticador.servicioweb.actualizarRol.WSActualizarRolSOAPStub(new java.net.URL(WSActualizarRolSOAP_address), this);
                _stub.setPortName(getWSActualizarRolSOAPWSDDServiceName());
                return _stub;
            }
        }

...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="OSM-ACCION">
		<pagina tipo_login="true">
			<javascript>publico/registro_signapp/registro_signapp.js</javascript>
										...
										<div id="formulario_solicitud" class="" style="display:block">
											...
											<div class="panel-body bloque_contenido_contenido">
												...
												<div
													...
													<div class="tb-text">
														<div class="Title-1">Registro</div>
													</div>
													...
													<div class="row col-md-12">
														...
														<div class="col-md-9">
															<input class="input-default form-input"
																type="text" placeholder="Ingresar valor" id="nit" />
														</div>
													</div>
													<div class="tb-text">
                                                        <div class="Subtitle-2">Representante Legal</div>
                                                    </div>
                                                    <div class="divider"></div>
                                                    <div class="row col-md-12">

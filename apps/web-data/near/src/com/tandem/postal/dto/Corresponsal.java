...
public class Corresponsal  implements java.io.Serializable {
    ...
    private com.tandem.postal.dto.Particular particular;
    ...
    public Corresponsal(
           ...
           com.tandem.postal.dto.Particular particular,
     ...
     * @return particular
     */
    public com.tandem.postal.dto.Particular getParticular() {
        return particular;
    }
     ...
     * @param particular
     */
    public void setParticular(com.tandem.postal.dto.Particular particular) {
        this.particular = particular;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://postal.tandem.com/dto/", "Corresponsal"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://postal.tandem.com/dto/", "Particular"));

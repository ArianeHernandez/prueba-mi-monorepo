...
public class Postal_AutoRechazo_Principal extends Abstract_Postal_Envio_DocSalida_Principal {
	
	static final Logger logger = LoggerFactory.getLogger(Postal_AutoRechazo_Principal.class);

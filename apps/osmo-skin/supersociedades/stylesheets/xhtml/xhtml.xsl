...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template name="pagina_simple">
        ...
        <html>
            ...
            <head>
                <title>Supersociedades - <xsl:value-of select="@titulo"/></title>
	...
	<xsl:template name="pagina">
        ...
        <html>
            ...
            <head>
            	...
            	<link rel="shortcut icon" href="{$contextPath}/{$rnd_version}/images/icon.png"/> 	
            		...
            		<div class="all" id="contentsidebar">
	            		...
	            		<div class="body-content">
							...
							<div >
			            		...
			            		<xsl:if test="count(//menu_plugins/*)>0 and count(//no-plugins)=0">
			            			<a href="#menu-toggle" class="btn btn-sidebar" id="menu-toggle"><i class="fa fa-bell"></i></a>
	...
	<xsl:template name="skin_footer">
		<div class="foot">
			...
			<p>Todos los Derechos Reservados 2020 - Superintendencia de Sociedades	</p>

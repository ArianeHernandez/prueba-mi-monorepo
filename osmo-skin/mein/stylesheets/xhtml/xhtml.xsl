...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template name="pagina_simple">
        ...
        <html>
            ...
            <head>
                <title>NEAR - Negociación de Emergencia de Acuerdos de Reorganización <xsl:value-of select="@titulo"/></title>
            	...
            	<link rel="shortcut icon" href="{$contextPath}/images/icon.ico"/>
                <script> var CONTEXTPATH = '<xsl:value-of select="$contextPath"/>';</script>
				
				<script type="text/javascript" src="{$contextPath}/publicfiles/underscore-min.js">;</script>                
                <script type="text/javascript" src="{$contextPath}/publicfiles/jquery/jquery-2.1.1.js">;</script>
				<script type="text/javascript" src="{$contextPath}/scripts/jquery/jquery-ui-1.10.4.js">;</script>
	...
	<xsl:template name="pagina">
        ...
        <html>
            ...
            <head>
            	...
            	<link rel="shortcut icon" href="{$contextPath}/{$rnd_version}/icons/icon.ico"/> 	
                ...
                <script type="text/javascript" src="{$contextPath}/{$rnd_version}/publicfiles/jquery/jquery-2.1.1.js">;</script>
				<script type="text/javascript" src="{$contextPath}/{$rnd_version}/scripts/jquery/jquery-ui-1.10.4.js">;</script>
	...
	<xsl:template name="skin_footer">
		<div class="foot">
			<div id="foot_inactive_bar">
				<div id="foot_inactive"> </div>
			</div>
			
			<p>Todos los Derechos Reservados 2020 - NEAR - Negociación de Emergencia de Acuerdos de Reorganización	</p>
...
<!--         <xsl:if test="@claveingresologin='true'"> -->
<!-- 	        <center style="margin: 20px 0px"> -->
<!-- 	        	<div class="g-recaptcha" data-sitekey="6Ldq4EwUAAAAAOWr1NgQkGc4BLZuJzmCikKx1UPs"></div> -->
<!-- 	        </center> -->
<!--         </xsl:if> -->
	...
	<xsl:template match="cajafecha">
		<input type="text" name="{@id}" id="{@id}" value="{@valor}" class="date-pick form-control"/>
	</xsl:template> 

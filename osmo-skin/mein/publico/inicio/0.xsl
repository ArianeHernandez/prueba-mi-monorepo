		...
		<pagina_simple tipo_login="true">
			...
			<principal >
				<contenido>
								...
								<div class="base_area">
									...
									<div class="form_area">
										<div class="intro-box ">
											...
											<h1>Negociación de Emergencia de Acuerdos de Reorganización</h1>
					...
					<div class="footer_area"><p>NEAR - Negociación de Emergencia de Acuerdos de Reorganización <br/> Todos los derechos reservados 2020 - <a href="#" targer="_blank" class="powerby">Power by Hightech Software</a></p></div>

  ...
  <xsl:template match="ex:exception-report">
    <html>
      ...
      <div id="area_error">
      	...
      	<p>El recurso al cual intenta ingresar no esta disponible. Por favor verifique la url e intentelo nuevamente.</p>
      	<p>Si el problema continua, puede intentar ir a la pagina de inicio.</p>

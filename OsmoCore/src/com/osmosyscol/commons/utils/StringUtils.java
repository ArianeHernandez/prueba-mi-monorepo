...
public class StringUtils extends org.apache.commons.lang.StringUtils {
	...
	public static String toStringB64(InputStream in) throws IOException {
	...
	public static String simpleDesCripto(String data) {
		...
		try {
			...
			for (int i = 0; i < data.length(); i += 3) {
				String a = data.substring(i, i + 3);
				if ("655".equals(a)) {
					a = data.substring(i, i + 5);
					i += 2;
				}
				res = res + ((char) (Integer.parseInt(a)));
			}
	...
	public static String toHTML(String data) {
		...
		String html = "";
		String[] lines = trimToEmpty(data).split("\n");
		for (String line : lines) {
			html = html + StringEscapeUtils.escapeXml(line) + "<br/>";
		}

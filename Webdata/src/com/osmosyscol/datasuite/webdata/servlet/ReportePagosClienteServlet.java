...
public class ReportePagosClienteServlet extends HttpServlet {
	...
	private void doDownload(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Integer pId_cliente =  (Integer) session.getAttribute("id_usuario");
		
		Filtro filtro = new Filtro();
		
		filtro.setId_cliente( pId_cliente );

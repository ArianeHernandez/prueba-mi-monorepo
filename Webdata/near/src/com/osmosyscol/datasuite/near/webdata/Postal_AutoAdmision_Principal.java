...
public class Postal_AutoAdmision_Principal extends Abstract_Postal_Envio_DocSalida_Principal {
	
	static final Logger logger = LoggerFactory.getLogger(Postal_AutoAdmision_Principal.class);

	@Override
	String getPuntoInteraccion() {
		return IPostalInteraccion.PUNTOINTERACCION_AUTOADMISION;
	}

...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="OSM-ACCION">
		...
		<pagina titulo="Consulta de productos y cuentas">
			<javascript>producto_cuentas/71.js</javascript>
			<principal>
								...
								<div class="panel-col col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 form-horizontal">
									<div class="form-horizontal">
										<div class="form-group form-group-sm">
											<label class="col-sm-4 control-label">Tipo de Identificacion</label>
											<div class="col-sm-8">
												<select class="form-control" ng-model="tipoDocumento" ng-options="tipoDocumento.id as tipoDocumento.nombre for tipoDocumento in listaTiposDocumento" required="required">
										...
										<div class="form-group form-group-sm">
											...
											<div class="col-sm-8">
												<input ng-model="numeroDocumento" type="text" class="form-control" maxlenght="25" required="required"/>
											</div>
										</div>
										<div style="padding-left: 84%; padding-top: 1%;" class="form-group form-group-sm">
											<button  type="button" class="btn btn-primary" ng-click="buscar()"><i class="fa fa-search" aria-hidden="true"></i>&#160; Buscar</button>
										</div>
									</div>
								</div>

...
public class GeneradorSIFAdminPortafolioTerceroFISICO implements IGeneradorSalidaSistemaCorreval {

	private String tipo_archivo = "APT-FISICO-SIF";
	...
	public File generar(List<SalidaCoreCorreval> listaSalidaSistemaCorreval) {
		...
		try{
			...
			HSSFCell ccel1 = rowc0.createCell((short) 0);
			ccel1.setCellValue(new HSSFRichTextString("Descripción del Negocio"));
			ccel1.setCellStyle(styleCelda);
			
			HSSFCell ccel2 = rowc0.createCell((short) 1);
			ccel2.setCellValue(new HSSFRichTextString("Descripción del Producto"));
			ccel2.setCellStyle(styleCelda);
			
			HSSFCell ccel3 = rowc0.createCell((short) 2);
			ccel3.setCellValue(new HSSFRichTextString("Cuenta"));
			ccel3.setCellStyle(styleCelda);
			
			HSSFCell ccel4 = rowc0.createCell((short) 3);
			ccel4.setCellValue(new HSSFRichTextString("Nombre del Cliente"));
			ccel4.setCellStyle(styleCelda);
			
			HSSFCell ccel5 = rowc0.createCell((short) 4);
			ccel5.setCellValue(new HSSFRichTextString("Valor de Retiro"));
			ccel5.setCellStyle(styleCelda);
			
			HSSFCell ccel6 = rowc0.createCell((short) 5);
			ccel6.setCellValue(new HSSFRichTextString("Tipo de Medio Fisico"));
			ccel6.setCellStyle(styleCelda);
			
			HSSFCell ccel7 = rowc0.createCell((short) 6);
			ccel7.setCellValue(new HSSFRichTextString("Nombre del Beneficiario"));
			ccel7.setCellStyle(styleCelda);
			
			HSSFCell ccel8 = rowc0.createCell((short) 7);
			ccel8.setCellValue(new HSSFRichTextString("Identificacion del Beneficiario"));
			ccel8.setCellStyle(styleCelda);
			
			HSSFCell ccel9 = rowc0.createCell((short) 8);
			ccel9.setCellValue(new HSSFRichTextString("Nombre del Banco de Giro del Medio Físico"));
			ccel9.setCellStyle(styleCelda);
			
			HSSFCell ccel10 = rowc0.createCell((short) 9);
			ccel10.setCellValue(new HSSFRichTextString("Numero Cuenta del Banco de Giro de Medio Físico"));
			ccel10.setCellStyle(styleCelda);
			
			HSSFCell ccel11 = rowc0.createCell((short) 10);
			ccel11.setCellValue(new HSSFRichTextString("Tipo de Entrega Medio Físico"));
			ccel11.setCellStyle(styleCelda);
			
			HSSFCell ccel12 = rowc0.createCell((short) 11);
			ccel12.setCellValue(new HSSFRichTextString("Dirección de Entrega Medio Físico"));
			ccel12.setCellStyle(styleCelda);
			
			HSSFCell ccel13 = rowc0.createCell((short) 12);
			ccel13.setCellValue(new HSSFRichTextString("Tipo Identificación de Autorizado a Recoge"));
			ccel13.setCellStyle(styleCelda);
			
			HSSFCell ccel14 = rowc0.createCell((short) 13);
			...
			for (SalidaCoreCorreval ssc : listaSalidaSistemaCorreval) {
				...
				HSSFCell cel1 = row.createCell((short) 0);
				cel1.setCellValue(new HSSFRichTextString(ssc.getDescripcion_negocio()));
				cel1.setCellStyle(styleCelda);
				
		
				HSSFCell cel2 = row.createCell((short) 1);
				cel2.setCellValue(new HSSFRichTextString(ssc.getDescripcion_producto()));
				cel2.setCellStyle(styleCelda);
				
				HSSFCell cel3 = row.createCell((short) 2);
				cel3.setCellValue(new HSSFRichTextString(ssc.getNum_cuenta_cliente_correval()));
				...
				HSSFCell cel18 = row.createCell((short) 17);
				cel18.setCellValue(new HSSFRichTextString(ssc.getNombre_agente_comercial()));

			...
			<principal>
				...
				<contenido>
					...
					<xsl:choose>
						...
						<xsl:when test="count(//Formato/id_formato)>0">
							<div class="mesg2">
								<p>El formato '<xsl:value-of select="//Formato/nombre"/>' se ha guardado Exitosamente.</p>
							</div>
						</xsl:when>

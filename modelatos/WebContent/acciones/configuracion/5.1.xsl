					...
					<bloque-pestanas>
						...
						<xsl:if test="not(//credencial_usuario/cambiar_clave = 'S')">
							<pestana titulo="Informacion Persona">
								...
								<formulario id="form_informacion" destino="configuracion/5.2.do">
									...
									<registro>
										...
										<valor>
											...
											<parrafo><xsl:value-of select="//LOGIN_USER"/></parrafo>
										</valor>
									</registro>
									...
									<registro>
										...
										<valor>
											<parrafo><xsl:value-of select="//obtenerPersona/Persona/identificacion"/></parrafo>
										</valor>
									</registro>
								...
								<area_botones>
									<boton estilo="guardar" formulario="form_informacion" validacion="page_validarInfoGuardar()">Guardar Información</boton>
								</area_botones>
						...
						<pestana titulo="Cambio de Contraseña">
							...
							<area_botones>
								<boton estilo="guardar" formulario="form_edicion" validacion="page_validarGuardar()">Cambiar Clave</boton>
							</area_botones>
